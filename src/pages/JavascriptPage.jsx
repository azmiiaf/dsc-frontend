...
const JavascriptPage = () => {
    ...
    const javascriptTopics = data.javascript_topics || [];

  return(
    <MainLayout title='Javascript Dasar'>
      <h2 className="text-2xl font-bold mb-6">Materi JavaScript Dasar</h2>
      <p className="text-gray-600 mb-6">Belajar dasar-dasar JavaScript untuk pengembangan web modern.</p>
      
      <div className="bg-white p-6 rounded-2xl shadow">
        <h3 className="font-semib1old text-lg mb-4">Topics:</h3>
            ...
            <div key={topic.id} className="mb-6 p-4 bg-gray-50 rounded-lg">
              ...
              {topic.example && (
                <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                  <h5 className="font-semibold mb-3">Contoh Kode JavaScript:</h5>
